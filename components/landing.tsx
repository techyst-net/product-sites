  ...
  return <main className={`site ${product.key}`}>
    <header className="nav shell">
      <Link className="brand" href={`/${product.key}`} aria-label={`${product.name} home`}>
        <Image src={`/marks/${product.key}.png`} alt="" width={42} height={42} priority />
